...
background-color: #ddd;
  ...
  <body>
    ...
    <p style="text-align:center;font-size:25px;color:#00001a;font-weight:bolder;padding-top:80px;">Find a Place That is Perfect Just for You</p>
    <p style="text-align:center;color:black;padding-top:20px;font-size:14px;padding-bottom:50px">Looking for a home or office to lease? Search from our carefully selected listings based on what matters most to you. Based on what you would like most, we have<br>
      something in every price range and from all over the city!</p>
    ...
    <img src="images/seven.jpg" alt="contact" style="max-width:100%;height:auto;">
     </div>
     <div class="col-5 col-s-10 menu">
       <div class="one" style="background-color:white;border-bottom:5px solid #000;padding:15px;">
      <p style="font-size:24px;color:#00001a;padding-top:35px;padding-left:20px;font-weight:bolder">Sieben</p>
  ...
  <div class="row">
   <div class="col-5 col-s-5 menu">
  <img src="images/eight.jpg" alt="contact" style="max-width:100%;height:auto;">
   </div>
   <div class="col-5 col-s-10 menu">
     <div class="one" style="background-color:white;border-bottom:5px solid #000;padding:14px;">
    <p style="font-size:24px;color:#00001a;padding-top:35px;padding-left:20px;font-weight:bolder">Acht</p>
    <p style="font-size:16px;color:black;font-weight:bolder;padding-top:20px;padding-left:20px;">xxxxx-xxxx-xxxx</p>
    <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxx</p>
     <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxxxxxx</p>
    <p style="padding-top:20px;padding-left:20px;"> A rare opportunity to own a level plot with subdivision scheme in a
...
<div class="row">
 <div class="col-5 col-s-5 menu">
<img src="images/nine.jpg" alt="contact" style="max-width:100%;height:auto;">
 </div>
 <div class="col-5 col-s-10 menu">
   <div class="one" style="background-color:white;border-bottom:5px solid #000;padding:15px;">
  <p style="font-size:24px;color:#00001a;padding-top:35px;padding-left:20px;font-weight:bolder">Neun</p>
  <p style="font-size:16px;color:black;font-weight:bolder;padding-top:20px;padding-left:20px;">xxxxx-xxxx-xxxx</p>
  <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxx</p>
   <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxxxxxx</p>
  <p style="padding-top:20px;padding-left:20px;"> A rare opportunity to own a level plot with subdivision scheme in a
...
<div class="row">
 <div class="col-5 col-s-5 menu">
<img src="images/ten.jpg" alt="contact" style="max-width:100%;height:auto;">
 </div>
 <div class="col-5 col-s-10 menu">
   <div class="one" style="background-color:white;border-bottom:5px solid #000;padding: 15px;">
  <p style="font-size:24px;color:#00001a;padding-top:35px;padding-left:20px;font-weight:bolder">Zehn</p>
  <p style="font-size:16px;color:black;font-weight:bolder;padding-top:20px;padding-left:20px;">xxxxx-xxxx-xxxx</p>
  <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxx</p>
   <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxxxxxx</p>
  <p style="padding-top:20px;padding-left:20px;"> A rare opportunity to own a level plot with subdivision scheme in a
...
<div class="row">
 <div class="col-5 col-s-5 menu">
<img src="images/eleven.jpg" alt="contact" style="max-width:100%;height:auto;">
 </div>
 <div class="col-5 col-s-10 menu">
   <div class="one" style="background-color:white;border-bottom:5px solid #000;padding: 15px;">
  <p style="font-size:24px;color:#00001a;padding-top:35px;padding-left:20px;font-weight:bolder">Elf</p>
  <p style="font-size:16px;color:black;font-weight:bolder;padding-top:20px;padding-left:20px;">xxxxx-xxxx-xxxx</p>
  <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxx</p>
   <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxxxxxx</p>
  <p style="padding-top:20px;padding-left:20px;"> A rare opportunity to own a level plot with subdivision scheme in a
...
<div class="row">
 <div class="col-5 col-s-5 menu">
<img src="images/twelve.jpg" alt="contact" style="max-width:100%;height:auto;">
 </div>
 <div class="col-5 col-s-10 menu">
   <div class="one" style="background-color:white;border-bottom:5px solid #000;padding: 10px;">
  <p style="font-size:24px;color:#00001a;padding-top:35px;padding-left:20px;font-weight:bolder">Zwolf</p>
  <p style="font-size:16px;color:black;font-weight:bolder;padding-top:20px;padding-left:20px;">xxxxx-xxxx-xxxx</p>
  <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxx</p>
   <p style="font-size:16px;color:black;font-weight:bolder;padding-left:20px;">xxxxxxxx</p>
  <p style="padding-top:20px;padding-left:20px;"> A rare opportunity to own a level plot with subdivision scheme in a
